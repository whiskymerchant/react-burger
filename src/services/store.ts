...
import { wsCloseFeed, wsConnectFeed, wsConnectingFeed, wsDisconnectFeed, wsErrorFeed, wsMessageFeed, wsOpenFeed } from "./reducers/feed/actions";
...
const store = configureStore({
  ...
  //     thunk: {
  //       extraArgument: refreshToken, // проверить пойдет ли рефрештокен тут: у Макса стоит весь класс Апи
  //     },
